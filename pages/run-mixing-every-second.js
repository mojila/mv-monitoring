...
export default class Index extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.mounted) {
            ...
            socket.on('run-mixing-every-second', (data) => this.setState({ data: JSON.parse(data), loading: false }));
                        ...
                        <div className="d-flex justify-content-between">
                            <div>
                                ...
                                <Menu>
                                    ...
                                    <MenuItem to="/downtime-mixing">Downtime Mixing</MenuItem>
                                    <MenuItem to="/run-mixing-every-second" active>Run Mixing Every Second</MenuItem>
                                </Menu>
                            </div>
